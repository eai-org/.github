...
[Read the publication on Medium](https://medium.com/engineering-in-the-age-of-ai)
...
- **[Francesco Borzì](https://github.com/FrancescoBorzi)** — co-founder
- **[Stefanos Lignos](https://github.com/stefanoslig)** — co-founder


## Follow along

- 📖 [Medium publication](https://medium.com/engineering-in-the-age-of-ai)
- 💬 Found a bug in companion code? Open an issue on the relevant repo — we treat article code like production code.

---

<sub>Opinions are our own. Code is MIT-licensed unless a repo says otherwise.</sub>
